...
void test_register_a(){
  Serial.println("Testing A Register");
  for (int i = 0 ; i < 256; ++i) {
  write_to_bus(i);
  delay(dt);
  set_register_a();
...
void test_register_b(){
  Serial.println("Testing B Register");
  for (int i = 0 ; i < 256; ++i) {
  write_to_bus(i);
  delay(dt);
  set_register_b();
